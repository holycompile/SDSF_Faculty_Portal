...
<body>
    <header class="topbar">
        ...
        <div class="tb-right">
            ...
            <a href="<?= BASE_URL ?>/admin/reports/generate_html_pdf.php?faculty_id=<?= $faculty['id'] ?>&month=<?= $currentMonth ?>&year=<?= $currentYear ?>" target="_blank" class="btn btn-primary btn-sm">
                ...
                Generate Bill &amp; Attendance PDF (Current Month)
            </a>
