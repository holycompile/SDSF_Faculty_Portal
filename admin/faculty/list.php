                        ...
                        <tr class="faculty-row" data-search="<?= strtolower(htmlspecialchars($f['name'].' '.$f['faculty_enrollment_no'].' '.$f['department'].' '.$f['email'].' '.$f['phone'])) ?>">
                            ...
                            <td style="text-align:right;">
                                <div style="display:inline-flex;gap:6px;">
                                    ...
                                    <a href="<?= BASE_URL ?>/admin/faculty/edit.php?id=<?= $f['id'] ?>" class="btn btn-outline btn-sm" title="Edit Profile &amp; Enrollment No.">
                                        Edit
                                    </a>
    ...
    <div style="background:#fff;border-radius:20px;padding:36px 32px;max-width:440px;width:90%;box-shadow:0 24px 64px rgba(0,0,0,0.22);animation:fadeUp .25s ease both;">
        ...
        <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:10px;padding:12px 16px;margin-bottom:24px;display:flex;gap:10px;align-items:flex-start;">
            ...
            <span style="font-size:12.5px;color:#1e40af;line-height:1.55;">
                <strong>Safe Backup Guaranteed:</strong> All profile data, assigned courses, conducted lectures, student attendance logs, and bills will be <strong>securely cloned and saved into Old Records</strong>. You can inspect or <strong>Restore</strong> them anytime.
            </span>
        </div>
        <!-- Buttons -->
